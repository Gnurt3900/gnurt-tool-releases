...
### 1. Bộ Tiêu Tiện Ích Cao Cấp (Premium Utilities)
*   🔑 **Password Vault**: Két sắt lưu trữ mật khẩu mã hóa AES-256 cục bộ, tích hợp trình sinh mật khẩu ngẫu nhiên và tự động xóa clipboard bảo mật sau 30 giây.
...
*   🌐 **Network Tools**: Công cụ đo độ trễ mạng (Ping) nội bộ và internet.
...
2.  **Giải nén** thư mục ra ổ đĩa của bạn.
3.  Nhấp đúp chuột vào tệp tin **`gnurt_tool.exe`** để mở ứng dụng và sử dụng ngay lập tức mà không cần cấu hình phức tạp.
